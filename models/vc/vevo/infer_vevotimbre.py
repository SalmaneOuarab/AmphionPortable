...
if __name__ == "__main__":
    ...
    content_wav_path = torch.load("./models/vc/vevo/wav/source_feats.pt")
    ...
    # source_feats = inference_pipeline.extract_source_features(content_wav_path)
    # torch.save(source_feats, "source_feats.pt")